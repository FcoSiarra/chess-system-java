...
public class ChessMatch {
    ...
    public boolean[][] possibleMoves(ChessPosition sourcePosition) {                 // imprime posibles posiciones desde posicion de origen

        Position position = sourcePosition.toPosition();                          // convierte en posicion de matriz normal
    ...
    public ChessPiece performChessMove(ChessPosition sourcePosition, ChessPosition targetPosition) {
        ...
        if (testCheck(currentPlayer)) { //REVISAR
    ...
    private void undoMove(Position source, Position target, Piece capturedPiece) {                // Deshacer movimiento para evitar posible jacke..
    ...
    private boolean testCheck(Color color) {
        ...
        for (Piece p : opponentPieces) {
            ...
            if (mat[kingPosition.getRow()][kingPosition.getColumn()]) {   // REVISAR
                return true;
            }
        }
        return false;
